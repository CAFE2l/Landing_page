...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-32 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-[#ff6b00]/[0.03] via-transparent to-transparent pointer-events-none" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto mb-32">
          ...
          <motion.div
            ...
            className="group relative p-8 rounded-3xl bg-white/[0.02] border border-white/[0.08] hover:bg-white/[0.04] hover:border-white/[0.12] transition-all duration-300"
          >
            <div className="absolute top-8 right-8 px-2 py-1 rounded-md bg-[#ff6b00]/10 border border-[#ff6b00]/20">
              <span className="text-[9px] text-[#ff6b00] font-bold uppercase tracking-wider">Exclusive for clients</span>
            </div>
            ...
            <a
              href="#"
              className="flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-[#ff6b00] text-white text-sm font-semibold shadow-[0_0_20px_rgba(255,107,0,0.3)] hover:shadow-[0_0_30px_rgba(255,107,0,0.5)] transition-all mb-4"
            >
              <img src="/imgs/icons/Telegram.png" alt="" className="w-4 h-4 brightness-0 invert" />
              Request VIP access
            </a>
        ...
        >
          ...
          <motion.a
            ...
            className="inline-flex items-center gap-2.5 bg-[#ff6b00] text-white px-10 py-4 rounded-xl text-base font-semibold shadow-[0_0_30px_rgba(255,107,0,0.4)] hover:shadow-[0_0_50px_rgba(255,107,0,0.6)] transition-all duration-300 animate-glow-pulse"
          >
