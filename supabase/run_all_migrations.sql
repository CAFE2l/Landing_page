...
-- ============================================================
-- MIGRATION 021: Sync user profile from auth metadata & feedback_posts
-- Backend-level fix for orphan profiles (full_name, username, email, avatar_url all null)
-- Run: supabase/migrations/021_sync_user_profile.sql
